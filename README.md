...
The user can also add five roller coasters to a favorites list. A maximum of five roller coasters can be added, and the next coaster added will be replaced by the last one.
